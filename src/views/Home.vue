      ...
      <v-row>
        <v-col cols="12">
          <v-row>
            ...
            <v-col cols="12" sm="6">
              <v-img src="/3.jpg" class="img1"></v-img>
            </v-col>
          </v-row>
        </v-col>
        <v-col cols="12" sm="12">
          <v-card flat>
            <v-tabs v-model="tab" color="indigo-lighten-1" align-tabs="center">
              <v-tab :value="1">
                <v-icon class="mr-2">mdi mdi-bed</v-icon>Hotel
              </v-tab>
              <v-tab :value="2">
                <v-icon class="mr-2">mdi mdi-airplane-takeoff</v-icon>Flight
              </v-tab>
              <v-tab :value="3">
                <v-icon class="mr-2">mdi mdi-car</v-icon>Car
              </v-tab>
              <v-tab :value="4">
                <v-icon class="mr-2">mdi mdi-ferry</v-icon>Ship
              </v-tab>
            </v-tabs>
              ...
              <v-window-item v-for="n in 4" :key="n" :value="n">
                <v-container fluid>
                  <v-row>
                    ...
                    <v-col cols="12" sm="2">
                      <v-btn class="text-none mt-5" color="indigo-lighten-1" size="x-large" variant="flat" rounded="0"
                        elevation="12">
                        Book Now
                      </v-btn>
                    </v-col>
        ...
        <v-col cols="12" sm="12">
          <h4 class="text-center text-indigo-lighten-1">Featured Tours</h4>
          <h1 class="text-center">Beautiful Places Arround The World</h1>
              ...
              <v-row>
                    ...
                    <v-card :elevation="isHovering ? 12 : 2" :class="{ 'on-hover': isHovering }" v-bind="props"
                      ...
                      <v-img src="/5.jpg" cover height="100%">
                        <div class="d-flex flex-row-reverse">
                          <v-btn class="text-none mr-2 mt-2" color="indigo-lighten-1" size="x-large" variant="flat"
                            rounded="0" elevation="12">
                            3 Packages
                          </v-btn>
                        </div>
                        <div class="text-white top">
                          <h1 class="mt-4">Paris</h1>
                          <div>
                  ...
                  <v-row>
                    <v-col cols="12" sm="12">
                      <v-hover v-slot="{ isHovering, props }">
                        <v-card :elevation="isHovering ? 12 : 2" :class="{ 'on-hover': isHovering }" v-bind="props"
                          class="card1">
                          <v-img src="/6.jpg" cover height="100%">
                            <div class="d-flex flex-row-reverse">
                              <v-btn class="text-none mr-2 mt-2" color="indigo-lighten-1" size="x-large" variant="flat"
                                rounded="0" elevation="12">
                                3 Packages
                    ...
                    <v-col cols="12" sm="12">
                      <v-hover v-slot="{ isHovering, props }">
                        <v-card :elevation="isHovering ? 12 : 2" :class="{ 'on-hover': isHovering }" v-bind="props"
                          class="card1">
                          <v-img src="/7.jpg" cover height="100%">
                            <div class="d-flex flex-row-reverse">
                              <v-btn class="text-none mr-2 mt-2" color="indigo-lighten-1" size="x-large" variant="flat"
                                rounded="0" elevation="12">
                                3 Packages
                ...
                <v-col cols="12" sm="4">
                  <v-hover v-slot="{ isHovering, props }">
                    <v-card :elevation="isHovering ? 12 : 2" :class="{ 'on-hover': isHovering }" v-bind="props"
                      class="card1">
                      <v-img src="/8.jpg" cover height="100%">
                        <div class="d-flex flex-row-reverse">
                          <v-btn class="text-none mr-2 mt-2" color="indigo-lighten-1" size="x-large" variant="flat"
                            rounded="0" elevation="12">
                            3 Packages
        ...
        <v-col cols="12" sm="12">
          <h4 class="text-center text-indigo-lighten-1">Popular Packeg</h4>
                  ...
                  <v-hover v-slot="{ isHovering, props }">
                    <v-card class="mx-auto" color="grey-lighten-4" max-width="600" v-bind="props">
                      <v-img :aspect-ratio="16 / 9" cover :src="popular.image">
                        <v-expand-transition>
                          <div v-if="isHovering"
                            class="d-flex transition-fast-in-fast-out bg-red-lighten-1 v-card--reveal"
                            style="height: 100%">
                            <v-row>
                              <v-col cols="12" sm="12">
                      ...
                      <v-card-actions>
                        ...
                        <v-rating v-model="rating" color="white" active-color="yellow-accent-4" half-increments hover
                          size="18"></v-rating>
                        <v-spacer></v-spacer>
                        <v-btn class="text-none" color="indigo-lighten-1" size="large" variant="flat" rounded="0"
                          elevation="6">$1200</v-btn>
                      </v-card-actions>
                    </v-card>
                  </v-hover>
                </v-col>
        ...
        <v-col cols="12" sm="12">
          <h4 class="text-center text-indigo-lighten-1">Inventore Veritatis</h4>
        ...
        <v-col cols="12" sm="12">
          <h4 class="text-center text-indigo-lighten-1">Popular Hotel</h4>
                  ...
                  <v-hover v-slot="{ isHovering, props }">
                    <v-card class="mx-auto" color="grey-lighten-4" max-width="600" v-bind="props">
                      <v-img :aspect-ratio="16 / 9" cover :src="hotel.image">
                        <v-expand-transition>
                          <div v-if="isHovering"
                            class="d-flex transition-fast-in-fast-out bg-teal-lighten-1 v-card--reveal"
                            style="height: 100%;">
                            <v-row>
                              <v-col cols="12" sm="12">
                                <h1 class="ml-4">{{ hotel.subtitle1 }}</h1>
                              </v-col>
                              <v-col cols="12" sm="12">
                                <h6 class="ml-4 mt-n4 mb-3">
                                  {{ hotel.subtitle2 }}
        ...
        <v-col cols=12 sm="12">
          <h4 class="text-center text-indigo-lighten-1">Our Gallery</h4>
          <h1 class="text-center">Best Traveler Share A photo</h1>
          <v-sheet class="mx-auto" elevation="8" max-width="1200">
            <v-slide-group v-model="model" class="pa-4" center-active show-arrows>
              <v-slide-group-item v-for="travel in travels" :key="travel" v-slot="{ isSelected, toggle }">
                <v-card :color="isSelected ? 'primary' : 'grey-lighten-1'" class="ma-4" height="200" width="130"
                  @click="toggle" flat>
          ...
          <v-card>
            <v-img src="/p.jpg" cover height="100%">
              ...
              <div class="d-flex justify-center ligne2">
                <v-text-field density="compact" placeholder="Enter your e-main here" variant="solo-inverted"
                  color="#393E50" rounded="0"></v-text-field>
                <v-btn class="text-none tp" color="indigo-lighten-1" size="large" variant="flat" rounded="0"
                  elevation="12">
                  Subscribe Now
                </v-btn>
              </div>
